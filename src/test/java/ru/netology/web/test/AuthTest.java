...
public class AuthTest {
    ...
    @Test
    @DisplayName("Should get error messege if login with not registered user")
    void shouldGetErrorMessegeIfLoginWithNotRegisteredUser(){
    ...
    void shouldErrorMessageIfLoginWithWrongLogin(){
        var registeredUser = getRegisteredUser("active");
